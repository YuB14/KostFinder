    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(10),
          border: Border.all(color: value ? AppColors.coral.withValues(alpha: 0.5) : border, width: 1.5),
        ),
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        color: card,
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: AppColors.coral.withValues(alpha: 0.3), width: 1.5),
        boxShadow: [BoxShadow(color: AppColors.coral.withValues(alpha: 0.08), blurRadius: 16)],
      ),
