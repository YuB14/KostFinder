...
class _FavoriteScreenState extends State<FavoriteScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Favorit Saya', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 18)),
        actions: [
          Padding(
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: fav.kostStatus == 'Aktif' ? const Color(0xFF008F78).withValues(alpha: 0.1) : const Color(0xFF6B7E94).withValues(alpha: 0.1),
