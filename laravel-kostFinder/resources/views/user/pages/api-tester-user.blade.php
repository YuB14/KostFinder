...
<div class="page active" id="page-api">
    <div class="page-header">
        ...
        <p>Uji endpoint REST API KostFinder dari sisi pengguna — lihat response JSON secara langsung.</p>
    </div>
    ...
    <div class="api-tester-layout">
        ...
        <div class="api-sidebar">
            ...
            <button class="api-resource-btn active" onclick="setApiResource('kost', this)">🏘️ Kost</button>
            ...
            <button class="api-resource-btn" onclick="setApiResource('stats', this)">📊 Statistik</button>
        </div>
        ...
        <div class="api-main">
            ...
            <div class="api-url-bar">
                ...
                <span class="api-url-text" id="api-url-text">/api/user/kost</span>
            </div>

            {{-- ID Input --}}
            <div class="api-input-row" id="api-id-row" style="display:none">
                <label>ID Resource</label>
                <input type="text" id="api-id-input" placeholder="Masukkan ID (untuk PUT, DELETE)"/>
            </div>
            ...
            {{-- Info Endpoints --}}
            <div class="api-info-panel" id="api-info">
                <div style="font-weight:700;margin-bottom:8px;font-size:13px">📌 Endpoint User yang Tersedia:</div>
                <div class="api-info-list" id="api-info-list">
                    <div class="api-info-item"><span class="api-info-method get">GET</span><code>/api/user/kost</code><span class="api-info-desc">Semua kost</span></div>
                    <div class="api-info-item"><span class="api-info-method get">GET</span><code>/api/user/review</code><span class="api-info-desc">Review saya</span></div>
                    <div class="api-info-item"><span class="api-info-method post">POST</span><code>/api/user/review</code><span class="api-info-desc">Tambah review</span></div>
                    <div class="api-info-item"><span class="api-info-method put">PUT</span><code>/api/user/review/{id}</code><span class="api-info-desc">Edit review</span></div>
                    <div class="api-info-item"><span class="api-info-method get">GET</span><code>/api/user/favorite</code><span class="api-info-desc">Favorit saya</span></div>
                    <div class="api-info-item"><span class="api-info-method post">POST</span><code>/api/user/favorite</code><span class="api-info-desc">Tambah favorit</span></div>
                    <div class="api-info-item"><span class="api-info-method delete">DELETE</span><code>/api/user/favorite/{id}</code><span class="api-info-desc">Hapus favorit</span></div>
                    <div class="api-info-item"><span class="api-info-method get">GET</span><code>/api/user/stats</code><span class="api-info-desc">Statistik user</span></div>
                </div>
            </div>
...
.api-info-panel{background:var(--card);border:1px solid var(--border);border-radius:14px;padding:16px 18px}
.api-info-list{display:flex;flex-direction:column;gap:6px}
.api-info-item{display:flex;align-items:center;gap:10px;font-size:12px;padding:4px 0}
.api-info-item code{font-family:'JetBrains Mono',monospace;background:var(--bg);padding:2px 8px;border-radius:6px;font-size:11px}
.api-info-method{padding:2px 8px;border-radius:4px;font-size:10px;font-weight:800;min-width:48px;text-align:center}
.api-info-method.get{background:rgba(56,178,172,.12);color:var(--teal)}
.api-info-method.post{background:rgba(232,67,13,.1);color:var(--coral)}
.api-info-method.put{background:rgba(255,193,7,.12);color:var(--yellow)}
.api-info-method.delete{background:rgba(229,62,62,.1);color:#E53E3E}
.api-info-desc{color:var(--muted);font-size:11px}
...
@push('scripts')
<script>
let apiResource = 'kost';
let apiMethod = 'GET';

const apiEndpoints = {
    kost: '/api/user/kost',
    review: '/api/user/review',
    favorite: '/api/user/favorite',
...
function updateApiUrl() {
    const base = apiEndpoints[apiResource] || '/api/user/' + apiResource;
